...
class Persona {
  ...
  String?
      nombre; //Esto en kotlin no se puede hacer, declarar una propiedad sin inicializar, asi sea nullable debe tener un valor inicial
  ...
  String _bio =
      "Hola, soy una propiedad privada"; //Poniendo un guión de piso indicamos que una variable es privada, pienso yo que se hizo de esta forma en Dart porque es la convención usada por desarrolladores de otros lenguajes como Java, Kotlin, etc.
...
/*   void set bio(String texto) {
  ...
  void set bio(String texto) => this._bio =
      texto; //Esto es lo mismo que el set de arriba, pero en una sola linea, es como en Kotlin, cuando omitimos las llaves y la palabra return en una función, se puede hacer cuando la función solo tiene una linea de código
...
/*   Persona( int edad, String nombre) {
  ...
  Persona.persona30(this.nombre) {
    //Acá en Dart no existe la sobrecarga de constructores, por lo que se usa el constructor con nombre(Se puede ver como una función de extensión que crea instancias de la clase) para crear otro constructor con los mismos parámetros, pero con otro nombre
    this.edad = 30;
  }
  ...
  //Constructor secundario con nombre que delega la inicialización al constructor primario, identico a como se hace en Kotlin
  Persona.constructorSecundario(int edad) : this(edad: edad);
